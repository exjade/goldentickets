...
exports.WeeklyDeleteReservedTickets = functions.pubsub.schedule('0 20 * * FRI').timeZone('America/Mexico_City').onRun((context) => {
    const collectionRef = db.collection('weekly-booking-tickets');
